...
urlpatterns = [
    ...
    path('stats/api/total', stats_api.get_total_stats, name='stats_total'),
    path('stats/api/top-users', stats_api.get_top_users, name='stats_top_users'),
    path('stats/api/top-category-users', stats_api.get_top_category_users, name='stats_top_category_users'),
    path('stats/api/days-saved', stats_api.get_days_saved_formatted, name='stats_days_saved'),
